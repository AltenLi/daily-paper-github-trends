---
title: "我在 GitHub 发现一个让 AI 写代码不容易失忆的工具：nihaisha-nishi-tcm"
date: "2026-06-10"
...
content_hash: "b92547b9632e528f97febe667f368357d97352cddc4ffb59250c7791cdc7ad0c"
---
# 我在 GitHub 发现一个让 AI 写代码不容易失忆的工具：nihaisha-nishi-tcm

我最近在看 GitHub 上和 AI coding agent 相关的工具，刷到一个挺有意思的库：**JuneYaooo/nihaisha-nishi-tcm**。

它不是那种“又套了一个聊天壳”的项目。它想解决的问题很朴素，也很真实：**AI 写代码一开始很猛，但项目一长、上下文一多、几天后再回来，很多决定就断片了。**

这也是我觉得它值得介绍给 AI 工程师的原因。

开源地址：https://github.com/JuneYaooo/nihaisha-nishi-tcm

## 1. 这个库到底想解决什么问题？

一句话：**它想把 AI coding agent 从“会写代码的聊天窗口”，改造成“按规格、上下文和流程工作的工程小队”。**

![nihaisha 微信交流群二维码](https://raw.githubusercontent.com/JuneYaooo/nihaisha-nishi-tcm/main/docs/wechat_code.jpg)
...
- GitHub 数据：约 568 stars、121 forks、2 open issues。
- License：未确认。
- 主要语言：Python。
- 最近更新：2026-06-05T09:23:18Z。
...
JuneYaooo/nihaisha-nishi-tcm 正好在这些问题上动手了。
...
当前 issue 样本：
- #4 能否把截屏示意图，替换成md？（comments=0）
- #2 好像没有对视频课程进行蒸馏，缺少视频中讲到的内容（comments=3）
