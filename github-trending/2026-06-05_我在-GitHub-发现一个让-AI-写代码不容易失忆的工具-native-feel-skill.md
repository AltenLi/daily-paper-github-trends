...
我最近在看 GitHub 上和 AI coding agent 相关的工具，刷到一个挺有意思的库：**yetone/native-feel-skill**。
...
- GitHub 数据：约 1706 stars、68 forks、1 open issues。
- License：MIT。
- 主要语言：未知。
- 最近更新：2026-05-30T15:12:34Z。
...
yetone/native-feel-skill 正好在这些问题上动手了。
