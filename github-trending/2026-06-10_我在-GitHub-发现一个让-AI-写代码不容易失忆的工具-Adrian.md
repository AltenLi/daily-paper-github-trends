---
title: "我在 GitHub 发现一个让 AI 写代码不容易失忆的工具：Adrian"
date: "2026-06-10"
...
content_hash: "533534b26466e45b27b710c19d163ebb56b5d60ce1da5087a3b346606d6f3492"
---
# 我在 GitHub 发现一个让 AI 写代码不容易失忆的工具：Adrian

![OpenAI Agents SDK](https://raw.githubusercontent.com/secureagentics/Adrian/main/assets/logos/openai-light.svg)

我最近在看 GitHub 上和 AI coding agent 相关的工具，刷到一个挺有意思的库：**secureagentics/Adrian**。

它不是那种“又套了一个聊天壳”的项目。它想解决的问题很朴素，也很真实：**AI 写代码一开始很猛，但项目一长、上下文一多、几天后再回来，很多决定就断片了。**

这也是我觉得它值得介绍给 AI 工程师的原因。

开源地址：https://github.com/secureagentics/Adrian

## 1. 这个库到底想解决什么问题？

一句话：**它想把 AI coding agent 从“会写代码的聊天窗口”，改造成“按规格、上下文和流程工作的工程小队”。**

![Adrian by Secure Agentics](https://raw.githubusercontent.com/secureagentics/Adrian/main/assets/adrian-logo-light.png)
...
> Agent 会调用工具，但缺少一套能长期复用的工程流程：先研究、再写规格、再执行、再验收、再沉淀记忆。
...
- GitHub 数据：约 260 stars、51 forks、5 open issues。
- License：Apache-2.0。
- 主要语言：Python。
- 最近更新：2026-06-09T16:01:16Z。
...
把 AI 编码从一次性聊天，推进到可记录、可复盘、可交接的流程。
...
secureagentics/Adrian 正好在这些问题上动手了。
...
当前 issue 样本：
- #43 [feature] Add native OpenAI Agents SDK support（comments=0）
- #42 Fix initial WebSocket connect after sync init（comments=1）
- #41 [bug] WebSocket never starts initial connection when init() runs before an event loop exists（comments=0）
- #40 feat:added typescript sdk supports openai-sdk（comments=0）
- #38 Add: add blocking gates for langgraph_stategraph and langchain_executor（comments=0）
